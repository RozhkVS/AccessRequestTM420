...
*{0:f(p1,p2)} — значение будет преобразовано в строку с помощью функции, зарегистрированной под именем f,
*этой функции будут переданы параметры p1 и p2 в массиве,
*количество и правила для параметров зависят от самой функции, однако есть несколько общих правил:
...
*5. Можно использовать вложенные маркеры: для {0:f({1})} будет передано ['значение_из_параметра_с_индексом_1'],
*в этом случае форматирование недопустимо, а значение передается то же, что было передано функции format
